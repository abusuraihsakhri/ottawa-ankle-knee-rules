"""
Command Line Interface for Ottawa Ankle Knee Rules.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="ottawa-ankle-knee-rules", description="Ottawa Ankle Knee Rules")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  OTTAWA ANKLE KNEE RULES")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Ottawa Ankle Knee Rules Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Ottawa Ankle Knee Rules API server on http://{args.host}:{args.port}")
