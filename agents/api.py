"""
FastAPI REST API Server for Ottawa Ankle Knee Rules.
"""
...
app = FastAPI(
    title="Ottawa Ankle Knee Rules API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "ottawa-ankle-knee-rules", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
